...
?>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main col-md-4 col-lg-4 col-sm-12 col-xs-12" style=" border-style: solid; border-width:20px;">
                    <h1 class="page-header text-center">Select Design</h1>
...
?> </h2> 
                ...
                <div class="col-md-4 col-lg-5 col-xs-12 col-sm-12" style="margin-top:10px;">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3>Stock Table</h3>
                        </div>
