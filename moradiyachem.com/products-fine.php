   ...
   <div class="container" >
    <div class="section_team" style="padding-bottom:50px;margin-top:0px;">
        ...
        <div class="col-md-9 col-sm-6 col-xs-12" style="padding-left:0px; margin-top:165px;">
          <h1 class="active_menu">Fine Chemicals</h1>
        </div>
        <div class="row">
          <div class="col-md-6 col-sm-3 col-xs-12">
            <div class="price_table">
              ...
              <div class="plan_list">
                <ul >
                  <li><strong>n-Butyl Bromide</strong></li>
                  <li><strong>n-Butyl Propargyl Carbomate</strong></li>
          ...
          <div class="col-md-6 col-sm-3 col-xs-12">
            <div class="price_table">
              ...
              <div class="plan_list">
                <ul>
                  <li><strong>109-65-9</strong></li>
                  <li><strong>76114-73-3</strong></li>
                  <li><strong>7726-95-6</strong></li>
                </ul>
              </div>
            </div>
          </div>
