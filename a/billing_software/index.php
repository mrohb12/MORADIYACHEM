...
if(isset($_GET['email']) && isset($_GET['key']))
{
	...
	if (mysql_num_rows($result_verify_email) == 1)
	{
		...
		{
			mysql_query("UPDATE users SET isactive=1 WHERE email ='".$email."' AND hash='".$key."' ") or die(mysql_error());
                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" name="frmLogin" id="frmLogin" onSubmit="javascript:return submitFrmLogin();" action="index.php" method="POST">
                                        ...
                                        <div class="form-group text-center m-t-30">
                                            <div class="col-sm-12">
                                                <a href="page-recoverpw.html" class="text-muted"><i class="fa fa-lock m-r-5"></i> Forgot your password?</a>                                            </div>
                                        </div>
