                                    ...
                                    <h4 class="m-t-0 header-title"><b>Outstanding Report</b></h4>
									 <table id="datatable-responsive" class="table table-striped  table-colored table-info dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody> <?php 
											...
											$dealer_result = mysql_query($query);
											$totalRecords = mysql_num_rows($dealer_result);
											$count = 1;
											if(mysql_num_rows($dealer_result) > 0)
											{	
												
												while($row = mysql_fetch_array($dealer_result))
												{
													...
													if(mysql_num_rows($dresult_sub) > 0)
													{	
														
														while($rows = mysql_fetch_array($dresult_sub))
														{  
