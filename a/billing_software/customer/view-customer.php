				...
				<div class="row heading-bg">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						...
						<li><a href="javascript:;"><span>Customer Management</span></a></li>
						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								...
								<div class="pull-right">
									<a href="add-customer.php" class="btn btn-warning btn-anim" data-toggle="tooltip" title="Add Customer".><i class="fa fa-plus"></i><span class="btn-text">Add Customer</span></a>
								</div>
