				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">Add Vendor</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="javascript:;"><span>Vendor Management</span></a></li>
											...
											<div class="col-md-12">
												<div class="form-wrap">
													<form action="#" class="form-horizontal">
														<div class="form-body">
															<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Vendor Info</h6>
														...
														<div class="form-actions mt-10 pull-right">
															<div class="row">
																<div class="col-md-12">
																	<div class="row">
																		<div class="col-md-12">
																			<button type="submit" class="btn btn-success  mr-10" title="Add Vendor">Add Vendor</button>
																			<a href="view-vendor.php" class="btn btn-default" title="Back">Back</a>
																		</div>
																	</div>
																</div>
