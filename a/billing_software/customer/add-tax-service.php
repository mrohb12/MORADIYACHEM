											...
											<div class="col-md-12">
												<div class="form-wrap">
													<form action="#" class="form-horizontal">
														<div class="form-body">
															<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Service Info</h6>
														...
														<div class="form-actions mt-10 pull-right">
															<div class="row">
																<div class="col-md-12">
																	<div class="row">
																		<div class="col-md-12">
																			<button type="submit" class="btn btn-success  mr-10" title="Add Service">Add Service</button>
																			<a href="view-tax-service.php" class="btn btn-default" title="Back">Back</a>
																		</div>
																	</div>
																</div>
