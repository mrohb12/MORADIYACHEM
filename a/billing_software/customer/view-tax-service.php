			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Tax Services Detail</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						<li><a href="dashboard.php">Dashboard</a></li>
						<li><a href="javascript:;"><span>Tax Service Management</span></a></li>
						<li class="active"><span>View Tax Services</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">View Tax Services</h6>
								</div>
								<div class="pull-right">
									<a href="add-tax-service.php" class="btn btn-warning btn-anim" data-toggle="tooltip" title="Add Tax Service".><i class="fa fa-plus"></i><span class="btn-text">Add Tax Service</span></a>
								</div>
