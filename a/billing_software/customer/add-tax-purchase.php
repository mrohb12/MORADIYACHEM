			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Tax Purchase</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						...
						<li class="active"><span>Tax Purchase</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
											...
											<div class="col-md-12">
												<div class="form-wrap">
													<form class="form-horizontal" role="form">
														<div class="form-body">
															<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Tax Purchase</h6>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div class="col-md-9">
																			<select class="form-control" onChange ="javascript:return getVenderAddress(this.value);">
																				<option value="">Select Vender</option>
																				<option value="1">Vender 1</option>
																				<option value="2">Vender 2</option>
																			</select>
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-md-6">
																	...
																	<div class="col-md-9" id="venderAddress">
																		<address class="mb-15">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div class="col-md-9">
																			<input type="text" class="form-control" id="email_hr" placeholder="Enter Bill No">
																		</div>
																	</div>
																</div>
																<!--/span-->
						...
						<div class="panel panel-default card-view">
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<div class="col-md-12">
										<div class="col-md-9">
											<div class="pull-left txt-dark"><h6>Add : Packing Charges</h6></div>
										</div>
										<div class="col-md-3">
											<div class="pull-left txt-dark">
												<input type="text" class="form-control" style="width:auto;display:inline-block" id="txtPackingChanges" name="txtPackingChanges">
											</div>
										</div>
									</div>
									<br/><br/><br/>
									<div class="col-md-12">
										<div class="col-md-9">
											<div class="pull-left txt-dark"><h6>Add : Courier</h6></div>
										</div>
										<div class="col-md-3">
											<div class="pull-left txt-dark">
												<input type="text" class="form-control" style="width:auto;display:inline-block" id="txtCourierChanges" name="txtCourierChanges">
											</div>
										</div>
									</div>
									<br/><br/><br/>
									<div class="col-md-12">
										<div class="col-md-9">
											<div class="pull-left txt-dark"><h6>Add : Insurance Charges</h6></div>
										</div>
										<div class="col-md-3">
											<div class="pull-left txt-dark">
												<input type="text" class="form-control" style="width:auto;display:inline-block" id="txtInsuranceChanges" name="txtInsuranceChanges">
											</div>
										</div>
									</div>
									<br/><br/><br/>
									<div class="col-md-12">
										<div class="col-md-9">
											<div class="pull-left txt-dark"><h6>Add : Other Charges</h6></div>
										</div>
										<div class="col-md-3">
											<div class="pull-left txt-dark">
												<input type="text" class="form-control" style="width:auto;display:inline-block" id="txtOtherChanges" name="txtOtherChanges">
											</div>
										</div>
									</div>
									<br/><br/><br/>
									<div class="col-md-12">
										<div class="col-md-3"></div>
										<div class="col-md-6">
											<div class="pull-right txt-dark"><h6>TOTAL TAXABLE VALUE FOR GOODS & SERVICES</h6></div>
										</div>
										<!--/span-->
										<div class="col-md-3">
											<div class="pull-left txt-dark"><input type="text" class="form-control" style="width:auto;display:inline-block" id="txtPackingChanges" name="txtPackingChanges"></div>
									...
									<div class="col-md-12">
										<div class="col-md-3"></div>
										<div class="col-md-6">
											<div class="pull-right txt-dark"><h6>SGST @14% Total</h6></div>
										</div>
										<!--/span-->
										<div class="col-md-3">
											<div class="pull-left txt-dark"><input type="text" class="form-control" style="width:auto;display:inline-block" id="txtPackingChanges" name="txtPackingChanges"></div>
									...
									<div class="col-md-12">
										<div class="col-md-3"></div>
										<div class="col-md-6">
											<div class="pull-right txt-dark"><h6>CGST @14% Total</h6></div>
										</div>
										<!--/span-->
										<div class="col-md-3">
											<div class="pull-left txt-dark"><input type="text" class="form-control" style="width:auto;display:inline-block" id="txtPackingChanges" name="txtPackingChanges"></div>
									...
									<div class="col-md-12">
										<div class="col-md-3"></div>
										<div class="col-md-6">
											<div class="pull-right txt-dark"><h6>IGST @.... Total</h6></div>
										</div>
										<!--/span-->
										<div class="col-md-3">
											<div class="pull-left txt-dark"><input type="text" class="form-control" style="width:auto;display:inline-block" id="txtPackingChanges" name="txtPackingChanges"></div>
									...
									<div class="col-md-12">
										<div class="col-md-9">
											<div class="txt-dark" style="text-align:center;"><h6>Total</h6></div>
										</div>
										<!--/span-->
										<div class="col-md-3">
											<div class="pull-left txt-dark"><input type="text" class="form-control" style="width:auto;display:inline-block" id="txtPackingChanges" name="txtPackingChanges"></div>
									...
									<div class="form-actions mt-10 pull-right">
										...
										<a href="view-tax-purchase.php" class="btn btn-default" title="Back">Back</a>
									</div>
								</div>
							</div>
						</div>
