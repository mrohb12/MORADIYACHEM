...
if(isset($_GET['editId']))
{
	...
	{
		$error = 'Not Found.';
		?><script>document.location="view-packages.php";</script><?php
	...
	if(isset($_POST["action"]) && $_POST["action"]=="edit")
	{
		if($txtPackageName !="" && $lsPackageValidity !="" )
		{
			if($error =='')
			{
				...
				if($result) 
				{
					?><script>document.location="view-packages.php?required=UP";</script><?php
				}
				else {
					?><script>document.location="view-packages.php?required=NUP";</script><?php
				}
			}
		}
		else {
		...
		{	
			if($error == '')
			{
				...
				if($result)
				{
					?><script>document.location="view-packages.php?required=IS";</script><?php
				}
				else {
					?><script>document.location="view-packages.php?required=NIS";</script><?php
				}
			}
		}
		else {
