						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
									...
									$qrySel = mysqli_query($conn,"SELECT * FROM dealer WHERE (endeffdate IS NULL OR endeffdate ='NULL' OR endeffdate='0000-00-00') AND id = {$lsDealer}");
											...
											{	
												while($prod_row = mysqli_fetch_array($prod_result))
												{
													?><tr>
														...
														<td><?php echo date('d-m-Y' , strtotime($prod_row['datetimex'])); ?></td>
