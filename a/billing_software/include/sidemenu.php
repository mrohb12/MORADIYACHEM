<div id="sidebar-menu">
	...
	<div class="dropdown" id="setting-dropdown">
		<ul class="dropdown-menu" style="">
			<!--<li><a href="add-user.php?action=edit&editId=<?php print($_SESSION['BLData']['id']);?>&from=prf"><i class="mdi mdi-face-profile m-r-5"></i> Profile</a></li>-->
	...
	<ul>
		...
		<li class="has_sub">
			<a href="dashboard.php" class="waves-effect" title="Dashboard"><i class="mdi mdi-view-dashboard"></i> <span> Dashboard </span> </a>
		</li>
		<li class="has_sub">
			...
			<ul class="list-unstyled"><?php
				...
				if($userInfo['user_type'] == "Admin"){	
					?>
					<li><a href="add-page-category.php" title="Add Module">Add Module</a></li>
					<li><a href="page-category.php" title="View Modules">View Modules</a></li>
					<li><a href="add-page.php" title="Add Sub Module">Add Sub Module</a></li>
					<li><a href="pages.php" title="View Sub Modules">View Sub Modules</a></li>
					<li><a href="assign-roles.php" title="Assign Modules">Assign Modules</a></li><?php
				}?>
			</ul>
		</li>
		<li class="has_sub">
			...
			<ul class="list-unstyled">				<li><a href="add-customer.php" title="Add Customer">Add Customer</a></li>
				<li><a href="view-customers.php" title="View Customers">View Customers</a></li>
			</ul>
		</li><?php
		if($userInfo['user_type'] == "Admin"){	
			?>			<li class="has_sub">				<a href="javascript:void(0);" class="waves-effect"><i class="fa  fa-male"></i><span>Dealer Management</span>  <span class="menu-arrow"></span></a>				<ul class="list-unstyled">					<li><a href="add-dealer.php" title="Add Dealer">Add Dealer</a></li>					<li><a href="dealers.php" title="View Dealer">View Dealer</a></li>				</ul>			</li><?php
		}?>
		<li class="has_sub">
		...
		<li>
			<a href="logout.php" class="waves-effect"><i class="mdi mdi mdi-logout"></i><span> Logout</span></a>
		</li>
	</ul>
</div>